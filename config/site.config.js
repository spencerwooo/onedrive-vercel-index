...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'fr3aky@p7pp.onmicrosoft.com',
  ...
  protectedRoutes: ['/Private', '/Secret'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:fr3aky@p7pp.onmicrosoft.com',
